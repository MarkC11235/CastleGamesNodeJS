...
const gameNames = ['2048', 'Bird', 'BlackJack', 'BlockStack', 'CubeDash', 'HangMan', 'IdleMining', 'Minesweeper',
                 'Memory', 'MeteorShower', 'MiniGolf', 'MuffinMaker', 'OppositesAttract',
...
function makeGameDiv(name){
    ...
    gameDiv.innerHTML += '<center><a href="'+name+'-.html"><p>'+name+'</p><img src="images/'+name+'.gif"></a></center>';
...
for(let i = 0; i < gameNames.length; i++){
    sideBar.innerHTML += '<center><a href="'+gameNames[i]+'-.html"><p>'+gameNames[i]+'</p></a></center>';
}